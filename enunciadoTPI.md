...
| CRUD dependiente  | 1. Ingrediente {depende de} CRUD TipoIngrediente<br>2. Plato {depende de} CRUD TipoPlatp y CRUD Ingrediente<br>3. PrecioPlato {depende de} CRUD Plato<br>4. Pedido {depende de} CRUD Plato                                                                                                                                                  |
...
| CUU/Epic          | 1. Realizar un pedido<br>2. Cancelar un pedido<br>3. Reponer stock                                                                                                                                                                                                                                                                          |
